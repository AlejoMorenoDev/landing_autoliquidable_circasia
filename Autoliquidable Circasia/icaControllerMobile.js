...
app.controller('icaController', ['$scope', 'icaService', 'icaSettings', '$window', function ($scope, icaService, icaSettings, $window) {
    ...
    $scope.CalcularSobretasaBomberil = function () {
        if (document.getElementById("txtSobretasa").readOnly == true) {
            ...
            document.getElementById("txtSobretasa").value = ($scope.DetalleDeclaracion.Sobretasa === 0 ?
    ...
    $scope.CalcularSancion = function () {
        ...
        if (now > DMax) {
            ...
            let sancionFinal = Math.min(Math.max(ValUVT, sancionInicial), $scope.DetalleDeclaracion.TotalImpuestosCargo);
    ...
    $scope.CalcularAnticipo = function () {
        ...
        if ($scope.TieneAnticipo === "Si") {
            ...
            if (now < $scope.DetalleDeclaracion.fechaMaxima) {
    ...
    $scope.CalcularRenglon40 = function () {
        ...
        document.getElementById("txtTotalPagoVoluntario").value = icaService.formatNum($scope.DetalleDeclaracion.TotalPagoVoluntario);
    }
